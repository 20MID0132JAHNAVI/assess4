...
next_que.onclick = ()=>{
if(que_count < thirdround.length - 1) {
que_count++;
que_numb++;
...
let que_question = '<span>' + thirdround[index].numb + ". " + thirdround[index].question + '</span>';
let ans_list = '<div class="answer">' + thirdround[index].options[0] + '<span></span></div>' +
'<div class="answer">' + thirdround[index].options[1] + '<span></span></div>' +
'<div class="answer">' + thirdround[index].options[2] + '<span></span></div>' +
'<div class="answer">' + thirdround[index].options[3] + '<span></span></div>' ;
...
let correctAnswer = thirdround[que_count].answer;
...
let totalCounTag = ' <span><p>' + index + '</p>of<p>' + thirdround.length + '</p>Questions</span>';
